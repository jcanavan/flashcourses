"""
FlashCourses- Test cases for API endpoints for get and retrieve for card and
deck endpoints
...
class APIgetStatusCodeDeckdetail(APITestCase):
    ...
    def setUp(self):
        """
        Sets up testing environment for GET method for card_retrieve and
        deck_retrieve based on unique_id.
        """
        ...
        self.detail_method_endpoint = [reverse(
